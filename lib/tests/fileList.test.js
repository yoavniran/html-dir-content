describe("fileList tests", () => {
    ...
    const mockGetFile = jest.fn(() => Promise.resolve('file'));
    let getFileList,
        dirCounter = 1,
        fileCounter = 1;
    ...
    beforeAll(() => {
        ...
        jest.mock("../utils", () => ({
            getFileFromFileEntry: mockGetFile,
            getListAsArray: (list) => Array.prototype.concat.apply([], list),
        }));

        getFileList = require("../fileList").default;
    });
    ...
    it("should return only 1 level with recursive false", async () => {
        ...
        expect(mockGetFile).toHaveBeenCalledTimes(4);
    ...
    it("should stop at bail level with recursive true", async () => {
        ...
        expect(mockGetFile).toHaveBeenCalledTimes(6);
    ...
    it("should return all tree with recursive true", async () => {
        ...
        */
        ...
        expect(mockGetFile).toHaveBeenCalledTimes(11);
